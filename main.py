...
def show_help(m):
    ...
    Для начала Вам необходимо Преобрести уникальный ключ в разделе 'Аккаунт'. После👇:
   Зайдите на сайт "Avito.ru" в Поиске вбейте 'Название вашего товара' После настройте необходимые фильтры и скопируйте ссылку из адресной строки браузера.
